...
class SecretBox(encoding.Encodable, StringFixer, object):
    ...
    The ciphertexts generated by :class:`~rbcl.secret.Secretbox` include a 16
    ...
    KEY_SIZE = rbcl.bindings.crypto_secretbox_KEYBYTES
    NONCE_SIZE = rbcl.bindings.crypto_secretbox_NONCEBYTES
    MACBYTES = rbcl.bindings.crypto_secretbox_MACBYTES
    MESSAGEBYTES_MAX = rbcl.bindings.crypto_secretbox_MESSAGEBYTES_MAX
    ...
    def encrypt(self, plaintext, nonce=None, encoder=encoding.RawEncoder):
        ...
        ciphertext = rbcl.bindings.crypto_secretbox(
    ...
    def decrypt(self, ciphertext, nonce=None, encoder=encoding.RawEncoder):
        ...
        plaintext = rbcl.bindings.crypto_secretbox_open(
