...
"""
The :mod:`rbcl.hash` module exposes one-shot interfaces
...
BLAKE2B_BYTES = rbcl.bindings.crypto_generichash_BYTES
"""Default digest size for :func:`blake2b` hash"""
BLAKE2B_BYTES_MIN = rbcl.bindings.crypto_generichash_BYTES_MIN
"""Minimum allowed digest size for :func:`blake2b` hash"""
BLAKE2B_BYTES_MAX = rbcl.bindings.crypto_generichash_BYTES_MAX
"""Maximum allowed digest size for :func:`blake2b` hash"""
BLAKE2B_KEYBYTES = rbcl.bindings.crypto_generichash_KEYBYTES
"""Default size of the ``key`` byte array for :func:`blake2b` hash"""
BLAKE2B_KEYBYTES_MIN = rbcl.bindings.crypto_generichash_KEYBYTES_MIN
"""Minimum allowed size of the ``key`` byte array for :func:`blake2b` hash"""
BLAKE2B_KEYBYTES_MAX = rbcl.bindings.crypto_generichash_KEYBYTES_MAX
"""Maximum allowed size of the ``key`` byte array for :func:`blake2b` hash"""
BLAKE2B_SALTBYTES = rbcl.bindings.crypto_generichash_SALTBYTES
"""Maximum allowed length of the ``salt`` byte array for
:func:`blake2b` hash"""
BLAKE2B_PERSONALBYTES = rbcl.bindings.crypto_generichash_PERSONALBYTES
"""Maximum allowed length of the ``personalization``
byte array for :func:`blake2b` hash"""

SIPHASH_BYTES = rbcl.bindings.crypto_shorthash_siphash24_BYTES
"""Size of the :func:`siphash24` digest"""
SIPHASH_KEYBYTES = rbcl.bindings.crypto_shorthash_siphash24_KEYBYTES
"""Size of the secret ``key`` used by the :func:`siphash24` MAC"""

SIPHASHX_AVAILABLE = rbcl.bindings.has_crypto_shorthash_siphashx24
"""``True`` if :func:`siphashx24` is available to be called"""

SIPHASHX_BYTES = rbcl.bindings.crypto_shorthash_siphashx24_BYTES
"""Size of the :func:`siphashx24` digest"""
SIPHASHX_KEYBYTES = rbcl.bindings.crypto_shorthash_siphashx24_KEYBYTES
"""Size of the secret ``key`` used by the :func:`siphashx24` MAC"""

_b2b_hash = rbcl.bindings.crypto_generichash_blake2b_salt_personal
_sip_hash = rbcl.bindings.crypto_shorthash_siphash24
_sip_hashx = rbcl.bindings.crypto_shorthash_siphashx24


def sha256(message, encoder=rbcl.encoding.HexEncoder):
    """
    ...
    :rtype: bytes
    """
    return encoder.encode(rbcl.bindings.crypto_hash_sha256(message))


def sha512(message, encoder=rbcl.encoding.HexEncoder):
    """
    ...
    :rtype: bytes
    """
    return encoder.encode(rbcl.bindings.crypto_hash_sha512(message))
...
def blake2b(
    ...
    salt=b"",
    person=b"",
    encoder=rbcl.encoding.HexEncoder,
):
    """
    ...
    :param key: the key to be set for keyed MAC/PRF usage; if set, the key
                must be at most :data:`~rbcl.hash.BLAKE2B_KEYBYTES_MAX` long
    :type key: bytes
...
def siphash24(message, key=b"", encoder=rbcl.encoding.HexEncoder):
    """
...
def siphashx24(message, key=b"", encoder=rbcl.encoding.HexEncoder):
    """
