...
_strbytes_plus_one = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_STRBYTES

AVAILABLE = bcl.bindings.has_crypto_pwhash_scryptsalsa208sha256

STRPREFIX = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_STRPREFIX

SALTBYTES = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_SALTBYTES

PASSWD_MIN = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_PASSWD_MIN
PASSWD_MAX = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_PASSWD_MAX

PWHASH_SIZE = _strbytes_plus_one - 1

BYTES_MIN = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_BYTES_MIN
BYTES_MAX = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_BYTES_MAX

MEMLIMIT_MIN = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_MIN
MEMLIMIT_MAX = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_MAX
OPSLIMIT_MIN = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_MIN
OPSLIMIT_MAX = bcl.bindings.crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_MAX

OPSLIMIT_INTERACTIVE = (
    bcl.bindings.crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_INTERACTIVE
)
MEMLIMIT_INTERACTIVE = (
    bcl.bindings.crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_INTERACTIVE
)
OPSLIMIT_SENSITIVE = (
    bcl.bindings.crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_SENSITIVE
)
MEMLIMIT_SENSITIVE = (
    bcl.bindings.crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_SENSITIVE
)
...
def kdf(
    ...
    encoder=bcl.encoding.RawEncoder,
):
    """
    ...
    n_log2, r, p = bcl.bindings.bcl_bindings_pick_scrypt_params(
        opslimit, memlimit
    )
    maxmem = memlimit + (2 ** 16)

    return encoder.encode(
        bcl.bindings.crypto_pwhash_scryptsalsa208sha256_ll(
...
def str(
    ...
    return bcl.bindings.crypto_pwhash_scryptsalsa208sha256_str(
...
def verify(password_hash, password):
    ...
    """
        ...
        % bcl.bindings.crypto_pwhash_scryptsalsa208sha256_STRBYTES,
        raising=exc.ValueError,
    )

    return bcl.bindings.crypto_pwhash_scryptsalsa208sha256_str_verify(
