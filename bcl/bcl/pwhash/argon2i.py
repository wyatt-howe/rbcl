...
STRPREFIX = bcl.bindings.crypto_pwhash_argon2i_STRPREFIX
...
MEMLIMIT_MAX = bcl.bindings.crypto_pwhash_argon2i_MEMLIMIT_MAX
MEMLIMIT_MIN = bcl.bindings.crypto_pwhash_argon2i_MEMLIMIT_MIN
OPSLIMIT_MAX = bcl.bindings.crypto_pwhash_argon2i_OPSLIMIT_MAX
OPSLIMIT_MIN = bcl.bindings.crypto_pwhash_argon2i_OPSLIMIT_MIN

OPSLIMIT_INTERACTIVE = bcl.bindings.crypto_pwhash_argon2i_OPSLIMIT_INTERACTIVE
MEMLIMIT_INTERACTIVE = bcl.bindings.crypto_pwhash_argon2i_MEMLIMIT_INTERACTIVE
OPSLIMIT_SENSITIVE = bcl.bindings.crypto_pwhash_argon2i_OPSLIMIT_SENSITIVE
MEMLIMIT_SENSITIVE = bcl.bindings.crypto_pwhash_argon2i_MEMLIMIT_SENSITIVE

OPSLIMIT_MODERATE = bcl.bindings.crypto_pwhash_argon2i_OPSLIMIT_MODERATE
MEMLIMIT_MODERATE = bcl.bindings.crypto_pwhash_argon2i_MEMLIMIT_MODERATE
...
def kdf(
    ...
    return encoder.encode(
        bcl.bindings.crypto_pwhash_alg(
...
def str(
    ...
    .. versionadded:: 1.2
    """
    return bcl.bindings.crypto_pwhash_str_alg(
