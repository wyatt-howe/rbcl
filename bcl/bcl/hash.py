...
"""
The :mod:`bcl.hash` module exposes one-shot interfaces
...
BLAKE2B_BYTES = bcl.bindings.crypto_generichash_BYTES
"""Default digest size for :func:`blake2b` hash"""
BLAKE2B_BYTES_MIN = bcl.bindings.crypto_generichash_BYTES_MIN
"""Minimum allowed digest size for :func:`blake2b` hash"""
BLAKE2B_BYTES_MAX = bcl.bindings.crypto_generichash_BYTES_MAX
"""Maximum allowed digest size for :func:`blake2b` hash"""
BLAKE2B_KEYBYTES = bcl.bindings.crypto_generichash_KEYBYTES
"""Default size of the ``key`` byte array for :func:`blake2b` hash"""
BLAKE2B_KEYBYTES_MIN = bcl.bindings.crypto_generichash_KEYBYTES_MIN
"""Minimum allowed size of the ``key`` byte array for :func:`blake2b` hash"""
BLAKE2B_KEYBYTES_MAX = bcl.bindings.crypto_generichash_KEYBYTES_MAX
"""Maximum allowed size of the ``key`` byte array for :func:`blake2b` hash"""
BLAKE2B_SALTBYTES = bcl.bindings.crypto_generichash_SALTBYTES
"""Maximum allowed length of the ``salt`` byte array for
:func:`blake2b` hash"""
BLAKE2B_PERSONALBYTES = bcl.bindings.crypto_generichash_PERSONALBYTES
"""Maximum allowed length of the ``personalization``
byte array for :func:`blake2b` hash"""

SIPHASH_BYTES = bcl.bindings.crypto_shorthash_siphash24_BYTES
"""Size of the :func:`siphash24` digest"""
SIPHASH_KEYBYTES = bcl.bindings.crypto_shorthash_siphash24_KEYBYTES
"""Size of the secret ``key`` used by the :func:`siphash24` MAC"""

SIPHASHX_AVAILABLE = bcl.bindings.has_crypto_shorthash_siphashx24
"""``True`` if :func:`siphashx24` is available to be called"""

SIPHASHX_BYTES = bcl.bindings.crypto_shorthash_siphashx24_BYTES
"""Size of the :func:`siphashx24` digest"""
SIPHASHX_KEYBYTES = bcl.bindings.crypto_shorthash_siphashx24_KEYBYTES
"""Size of the secret ``key`` used by the :func:`siphashx24` MAC"""

_b2b_hash = bcl.bindings.crypto_generichash_blake2b_salt_personal
_sip_hash = bcl.bindings.crypto_shorthash_siphash24
_sip_hashx = bcl.bindings.crypto_shorthash_siphashx24


def sha256(message, encoder=bcl.encoding.HexEncoder):
    """
    ...
    :rtype: bytes
    """
    return encoder.encode(bcl.bindings.crypto_hash_sha256(message))


def sha512(message, encoder=bcl.encoding.HexEncoder):
    """
    ...
    :rtype: bytes
    """
    return encoder.encode(bcl.bindings.crypto_hash_sha512(message))
...
def blake2b(
    ...
    salt=b"",
    person=b"",
    encoder=bcl.encoding.HexEncoder,
):
    """
    ...
    :param key: the key to be set for keyed MAC/PRF usage; if set, the key
                must be at most :data:`~bcl.hash.BLAKE2B_KEYBYTES_MAX` long
    :type key: bytes
...
def siphash24(message, key=b"", encoder=bcl.encoding.HexEncoder):
    """
...
def siphashx24(message, key=b"", encoder=bcl.encoding.HexEncoder):
    """
