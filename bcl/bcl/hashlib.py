...
import bcl.bindings
from bcl.utils import bytes_as_string

BYTES = bcl.bindings.crypto_generichash_BYTES
BYTES_MIN = bcl.bindings.crypto_generichash_BYTES_MIN
BYTES_MAX = bcl.bindings.crypto_generichash_BYTES_MAX
KEYBYTES = bcl.bindings.crypto_generichash_KEYBYTES
KEYBYTES_MIN = bcl.bindings.crypto_generichash_KEYBYTES_MIN
KEYBYTES_MAX = bcl.bindings.crypto_generichash_KEYBYTES_MAX
SALTBYTES = bcl.bindings.crypto_generichash_SALTBYTES
PERSONALBYTES = bcl.bindings.crypto_generichash_PERSONALBYTES

SCRYPT_AVAILABLE = bcl.bindings.has_crypto_pwhash_scryptsalsa208sha256

_b2b_init = bcl.bindings.crypto_generichash_blake2b_init
_b2b_final = bcl.bindings.crypto_generichash_blake2b_final
_b2b_update = bcl.bindings.crypto_generichash_blake2b_update
...
def scrypt(password, salt="", n=2 ** 20, r=8, p=1, maxmem=2 ** 25, dklen=64):
    ...
    """
    return bcl.bindings.crypto_pwhash_scryptsalsa208sha256_ll(
